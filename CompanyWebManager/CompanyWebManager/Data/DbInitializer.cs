...
namespace CompanyWebManager.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Address { Street = "Testowa 1/11", Town = "Bydgoszcz", PostalCode = "85-333", VoivodeshipID = 2, CountryID = 176 },
                new Address { Street = "Testowa 2/122", Town = "warszawa", PostalCode = "22-333", VoivodeshipID = 5, CountryID = 176 },
                new Address { Street = "Testowa 3", Town = "paterek", PostalCode = "89-100", VoivodeshipID = 2, CountryID = 176 },
                new Address { Street = "Simple Street 1", Town = "new york", PostalCode = "", VoivodeshipID = null, CountryID = 230 },
                new Address { Street = "Simple Street 2", Town = "dallas", PostalCode = "", VoivodeshipID = null, CountryID = 230 },
            };
